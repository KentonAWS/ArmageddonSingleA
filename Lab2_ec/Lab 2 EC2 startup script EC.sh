...
<head>
    ...
    <title>Ephraim Carson | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://images.unsplash.com/photo-1768695089167-293dd344cc87?q=80&w=1240&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <!-- HEADER WITH NAME -->
            <header>
                <h1>Ephraim Carson</h1>
                <p>GenX | SAA | Liberated</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>Finally getting off the plantation.</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://i.pinimg.com/736x/ee/f9/a3/eef9a30cb1c9d118738d1814cda030a7.jpg" alt="Photon Particle Physics Concept">
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>Questions, collaborations, or inquiries? ephraimcarson@hotmail.com.</p>
            </section>
